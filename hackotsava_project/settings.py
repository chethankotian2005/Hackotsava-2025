"""
Django settings for Hackotsava 2025 Event Photo Finder project.
"""
...
INSTALLED_APPS = [
    ...
    'crispy_forms',
    'crispy_bootstrap4',
    'django_cleanup.apps.CleanupConfig',  # Automatic cleanup of old files
...
ROOT_URLCONF = 'hackotsava_project.urls'
...
WSGI_APPLICATION = 'hackotsava_project.wsgi.application'
